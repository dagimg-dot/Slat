...
import com.dagimg.slat.appContainer
...
class SlatAccessibilityService : AccessibilityService() {
    companion object {
        private const val TAG = "SlatAccessibility"
        const val PREF_AUTO_CAPTURE = "auto_capture_enabled"

        @Volatile
        private var instance: SlatAccessibilityService? = null
        ...
        fun getInstance(): SlatAccessibilityService? = instance
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent?) {
        ...
        if (event.eventType == AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED && packageName != null) {
            if (!IGNORED_PACKAGES.contains(packageName) && !packageName.startsWith("com.dagimg.slat")) {
